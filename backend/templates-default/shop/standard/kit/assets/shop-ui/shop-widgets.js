var ue=globalThis,he=ue.ShadowRoot&&(ue.ShadyCSS===void 0||ue.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Oe=Symbol(),pt=new WeakMap,te=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==Oe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(he&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=pt.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&pt.set(t,e))}return e}toString(){return this.cssText}},mt=s=>new te(typeof s=="string"?s:s+"",void 0,Oe),m=(s,...e)=>{let t=s.length===1?s[0]:e.reduce((i,a,o)=>i+(c=>{if(c._$cssResult$===!0)return c.cssText;if(typeof c=="number")return c;throw Error("Value passed to 'css' function must be a 'css' function result: "+c+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+s[o+1],s[0]);return new te(t,s,Oe)},gt=(s,e)=>{if(he)s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),a=ue.litNonce;a!==void 0&&i.setAttribute("nonce",a),i.textContent=t.cssText,s.appendChild(i)}},Ne=he?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return mt(t)})(s):s;var{is:ps,defineProperty:ms,getOwnPropertyDescriptor:gs,getOwnPropertyNames:fs,getOwnPropertySymbols:bs,getPrototypeOf:ys}=Object,pe=globalThis,ft=pe.trustedTypes,_s=ft?ft.emptyScript:"",vs=pe.reactiveElementPolyfillSupport,se=(s,e)=>s,Ie={toAttribute(s,e){switch(e){case Boolean:s=s?_s:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},yt=(s,e)=>!ps(s,e),bt={attribute:!0,type:String,converter:Ie,reflect:!1,useDefault:!1,hasChanged:yt};Symbol.metadata??=Symbol("metadata"),pe.litPropertyMetadata??=new WeakMap;var N=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=bt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),a=this.getPropertyDescriptor(e,i,t);a!==void 0&&ms(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){let{get:a,set:o}=gs(this.prototype,e)??{get(){return this[t]},set(c){this[t]=c}};return{get:a,set(c){let g=a?.call(this);o?.call(this,c),this.requestUpdate(e,g,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??bt}static _$Ei(){if(this.hasOwnProperty(se("elementProperties")))return;let e=ys(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(se("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(se("properties"))){let t=this.properties,i=[...fs(t),...bs(t)];for(let a of i)this.createProperty(a,t[a])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,a]of t)this.elementProperties.set(i,a)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let a=this._$Eu(t,i);a!==void 0&&this._$Eh.set(a,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let a of i)t.unshift(Ne(a))}else e!==void 0&&t.push(Ne(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return gt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,i);if(a!==void 0&&i.reflect===!0){let o=(i.converter?.toAttribute!==void 0?i.converter:Ie).toAttribute(t,i.type);this._$Em=e,o==null?this.removeAttribute(a):this.setAttribute(a,o),this._$Em=null}}_$AK(e,t){let i=this.constructor,a=i._$Eh.get(e);if(a!==void 0&&this._$Em!==a){let o=i.getPropertyOptions(a),c=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:Ie;this._$Em=a;let g=c.fromAttribute(t,o.type);this[a]=g??this._$Ej?.get(a)??g,this._$Em=null}}requestUpdate(e,t,i,a=!1,o){if(e!==void 0){let c=this.constructor;if(a===!1&&(o=this[e]),i??=c.getPropertyOptions(e),!((i.hasChanged??yt)(o,t)||i.useDefault&&i.reflect&&o===this._$Ej?.get(e)&&!this.hasAttribute(c._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:a,wrapped:o},c){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,c??t??this[e]),o!==!0||c!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[a,o]of this._$Ep)this[a]=o;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[a,o]of i){let{wrapped:c}=o,g=this[a];c!==!0||this._$AL.has(a)||g===void 0||this.C(a,void 0,o,g)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};N.elementStyles=[],N.shadowRootOptions={mode:"open"},N[se("elementProperties")]=new Map,N[se("finalized")]=new Map,vs?.({ReactiveElement:N}),(pe.reactiveElementVersions??=[]).push("2.1.2");var Me=globalThis,_t=s=>s,me=Me.trustedTypes,vt=me?me.createPolicy("lit-html",{createHTML:s=>s}):void 0,Le="$lit$",I=`lit$${Math.random().toFixed(9).slice(2)}$`,De="?"+I,$s=`<${De}>`,F=document,re=()=>F.createComment(""),ae=s=>s===null||typeof s!="object"&&typeof s!="function",Be=Array.isArray,Pt=s=>Be(s)||typeof s?.[Symbol.iterator]=="function",He=`[
\f\r]`,ie=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,$t=/-->/g,wt=/>/g,q=RegExp(`>|${He}(?:([^\\s"'>=/]+)(${He}*=${He}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`,"g"),St=/'/g,kt=/"/g,xt=/^(?:script|style|textarea|title)$/i,qe=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),n=qe(1),Ws=qe(2),Ks=qe(3),H=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),At=new WeakMap,z=F.createTreeWalker(F,129);function Et(s,e){if(!Be(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return vt!==void 0?vt.createHTML(e):e}var Ct=(s,e)=>{let t=s.length-1,i=[],a,o=e===2?"<svg>":e===3?"<math>":"",c=ie;for(let g=0;g<t;g++){let d=s[g],y,$,p=-1,_=0;for(;_<d.length&&(c.lastIndex=_,$=c.exec(d),$!==null);)_=c.lastIndex,c===ie?$[1]==="!--"?c=$t:$[1]!==void 0?c=wt:$[2]!==void 0?(xt.test($[2])&&(a=RegExp("</"+$[2],"g")),c=q):$[3]!==void 0&&(c=q):c===q?$[0]===">"?(c=a??ie,p=-1):$[1]===void 0?p=-2:(p=c.lastIndex-$[2].length,y=$[1],c=$[3]===void 0?q:$[3]==='"'?kt:St):c===kt||c===St?c=q:c===$t||c===wt?c=ie:(c=q,a=void 0);let b=c===q&&s[g+1].startsWith("/>")?" ":"";o+=c===ie?d+$s:p>=0?(i.push(y),d.slice(0,p)+Le+d.slice(p)+I+b):d+I+(p===-2?g:b)}return[Et(s,o+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},ne=class s{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let o=0,c=0,g=e.length-1,d=this.parts,[y,$]=Ct(e,t);if(this.el=s.createElement(y,i),z.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=z.nextNode())!==null&&d.length<g;){if(a.nodeType===1){if(a.hasAttributes())for(let p of a.getAttributeNames())if(p.endsWith(Le)){let _=$[c++],b=a.getAttribute(p).split(I),w=/([.?@])?(.*)/.exec(_);d.push({type:1,index:o,name:w[2],strings:b,ctor:w[1]==="."?fe:w[1]==="?"?be:w[1]==="@"?ye:G}),a.removeAttribute(p)}else p.startsWith(I)&&(d.push({type:6,index:o}),a.removeAttribute(p));if(xt.test(a.tagName)){let p=a.textContent.split(I),_=p.length-1;if(_>0){a.textContent=me?me.emptyScript:"";for(let b=0;b<_;b++)a.append(p[b],re()),z.nextNode(),d.push({type:2,index:++o});a.append(p[_],re())}}}else if(a.nodeType===8)if(a.data===De)d.push({type:2,index:o});else{let p=-1;for(;(p=a.data.indexOf(I,p+1))!==-1;)d.push({type:7,index:o}),p+=I.length-1}o++}}static createElement(e,t){let i=F.createElement("template");return i.innerHTML=e,i}};function V(s,e,t=s,i){if(e===H)return e;let a=i!==void 0?t._$Co?.[i]:t._$Cl,o=ae(e)?void 0:e._$litDirective$;return a?.constructor!==o&&(a?._$AO?.(!1),o===void 0?a=void 0:(a=new o(s),a._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=a:t._$Cl=a),a!==void 0&&(e=V(s,a._$AS(s,e.values),a,i)),e}var ge=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,a=(e?.creationScope??F).importNode(t,!0);z.currentNode=a;let o=z.nextNode(),c=0,g=0,d=i[0];for(;d!==void 0;){if(c===d.index){let y;d.type===2?y=new j(o,o.nextSibling,this,e):d.type===1?y=new d.ctor(o,d.name,d.strings,this,e):d.type===6&&(y=new _e(o,this,e)),this._$AV.push(y),d=i[++g]}c!==d?.index&&(o=z.nextNode(),c++)}return z.currentNode=F,a}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},j=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,a){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=V(this,e,t),ae(e)?e===l||e==null||e===""?(this._$AH!==l&&this._$AR(),this._$AH=l):e!==this._$AH&&e!==H&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Pt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==l&&ae(this._$AH)?this._$AA.nextSibling.data=e:this.T(F.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,a=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ne.createElement(Et(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{let o=new ge(a,this),c=o.u(this.options);o.p(t),this.T(c),this._$AH=o}}_$AC(e){let t=At.get(e.strings);return t===void 0&&At.set(e.strings,t=new ne(e)),t}k(e){Be(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,a=0;for(let o of e)a===t.length?t.push(i=new s(this.O(re()),this.O(re()),this,this.options)):i=t[a],i._$AI(o),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=_t(e).nextSibling;_t(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},G=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,a,o){this.type=1,this._$AH=l,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=l}_$AI(e,t=this,i,a){let o=this.strings,c=!1;if(o===void 0)e=V(this,e,t,0),c=!ae(e)||e!==this._$AH&&e!==H,c&&(this._$AH=e);else{let g=e,d,y;for(e=o[0],d=0;d<o.length-1;d++)y=V(this,g[i+d],t,d),y===H&&(y=this._$AH[d]),c||=!ae(y)||y!==this._$AH[d],y===l?e=l:e!==l&&(e+=(y??"")+o[d+1]),this._$AH[d]=y}c&&!a&&this.j(e)}j(e){e===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},fe=class extends G{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===l?void 0:e}},be=class extends G{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==l)}},ye=class extends G{constructor(e,t,i,a,o){super(e,t,i,a,o),this.type=5}_$AI(e,t=this){if((e=V(this,e,t,0)??l)===H)return;let i=this._$AH,a=e===l&&i!==l||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==l&&(i===l||a);a&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},_e=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){V(this,e)}},Rt={M:Le,P:I,A:De,C:1,L:Ct,R:ge,D:Pt,V,I:j,H:G,N:be,U:ye,B:fe,F:_e},ws=Me.litHtmlPolyfillSupport;ws?.(ne,j),(Me.litHtmlVersions??=[]).push("3.3.3");var Tt=(s,e,t)=>{let i=t?.renderBefore??e,a=i._$litPart$;if(a===void 0){let o=t?.renderBefore??null;i._$litPart$=a=new j(e.insertBefore(re(),o),o,void 0,t??{})}return a._$AI(s),a};var ze=globalThis,L=class extends N{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Tt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return H}};L._$litElement$=!0,L.finalized=!0,ze.litElementHydrateSupport?.({LitElement:L});var Ss=ze.litElementPolyfillSupport;Ss?.({LitElement:L});(ze.litElementVersions??=[]).push("4.2.2");var W={form:"",heading:"",label:"",input:"",select:"",check:"",button:"",buttonPrimary:"",buttonSecondary:"",alertError:"",alertSuccess:"",alertInfo:"",link:"",muted:""},oe={bootstrap5:{name:"bootstrap5",detect:'link[rel~="stylesheet"][href*="bootstrap"]',classes:{...W,heading:"h4",label:"form-label",input:"form-control",select:"form-select",check:"form-check-input",button:"btn btn-outline-dark",buttonPrimary:"btn btn-primary",buttonSecondary:"btn btn-secondary",alertError:"alert alert-danger",alertSuccess:"alert alert-success",alertInfo:"alert alert-primary",muted:"text-secondary"}},pure:{name:"pure",detect:'link[rel~="stylesheet"][href*="pure"]',classes:{...W,form:"pure-form pure-form-stacked",input:"pure-input-1",select:"pure-input-1",button:"pure-button",buttonPrimary:"pure-button pure-button-primary",buttonSecondary:"pure-button"}},tailwind:{name:"tailwind",detect:'link[rel~="stylesheet"][href*="tailwind"]',classes:{...W,heading:"text-xl font-semibold",label:"block mb-1",input:"block w-full rounded border border-gray-300 px-3 py-2 text-base focus:border-blue-500",select:"block w-full rounded border border-gray-300 px-3 py-2 text-base focus:border-blue-500",check:"rounded border-gray-300",button:"inline-block rounded px-4 py-2 bg-gray-200 text-gray-900 hover:bg-gray-300 disabled:opacity-60",buttonPrimary:"inline-block rounded px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-60",buttonSecondary:"inline-block rounded px-4 py-2 bg-gray-700 text-white hover:bg-gray-800 disabled:opacity-60",alertError:"rounded border border-red-300 bg-red-50 px-4 py-3 text-red-800",alertSuccess:"rounded border border-green-300 bg-green-50 px-4 py-3 text-green-800",alertInfo:"rounded border border-sky-300 bg-sky-50 px-4 py-3 text-sky-800",link:"underline",muted:"text-gray-500"}},custom:{name:"custom",detect:null,classes:{...W}},none:{name:"none",detect:null,classes:{...W}}},ve="bootstrap5",oi=Object.keys(W);function Ut(s){return oe[s]||oe[ve]}function Ot(s,e){if(!e)return s;let t={...s.classes},i=[];for(let[a,o]of Object.entries(e))a in t?t[a]=String(o):i.push(a);return i.length&&typeof console<"u"&&console.warn("[shop-ui] unbekannte Rollen in shopui.classes:",i.join(", ")),{...s,classes:t}}var $e=null,we=oe[ve],ks=typeof CSSStyleSheet<"u"&&"replaceSync"in CSSStyleSheet.prototype&&"adoptedStyleSheets"in Document.prototype;function As(){return document.readyState!=="loading"?Promise.resolve():new Promise(s=>document.addEventListener("DOMContentLoaded",s,{once:!0}))}function Nt(s){if(!s)return null;if(typeof s=="object")return s;try{return JSON.parse(s)}catch{return console.warn("[shop-ui] data-shop-ui-classes ist kein gueltiges JSON, wird ignoriert"),null}}function Ps(s){if(!s||typeof location>"u")return{};let e=new URLSearchParams(location.search),t=e.get("shop-ui-theme")||"",i=e.get("shop-ui-stylesheet")||"",a={};if(t&&t in oe&&(a.theme=t),i){let o=new URL(i,document.baseURI);o.origin===location.origin?a.stylesheet=o.href:console.warn("[shop-ui] shop-ui-stylesheet ignoriert: nicht same-origin")}return a}function xs(){let s=typeof window<"u"&&window.ShopUIConfig||{},e=document.querySelector("script[data-shop-ui-theme]"),t=Ps(e&&e.dataset.shopUiAllowUrl==="true");return{theme:t.theme||s.theme||e&&e.dataset.shopUiTheme||ve,stylesheet:t.stylesheet||s.stylesheet||e&&e.dataset.shopUiStylesheet||"",classes:Nt(s.classes)||Nt(e&&e.dataset.shopUiClasses)||null}}function Es(s,e){if(e)return new URL(e,document.baseURI).href;if(!s.detect)return null;let t=document.querySelector(s.detect);return t?t.href:null}function It(){return $e||($e=As().then(()=>{let s=xs(),e=Ot(Ut(s.theme),s.classes);we=e;let t=Es(e,s.stylesheet);return t?fetch(t,{credentials:"same-origin"}).then(i=>i.ok?i.text():"").then(i=>({preset:e,text:i})):{preset:e,text:""}}).then(({preset:s,text:e})=>{if(!e)return{preset:s,sheet:null,text:""};if(!ks)return{preset:s,sheet:null,text:e};let t=new CSSStyleSheet;return t.replaceSync(e),{preset:s,sheet:t,text:e}}).catch(()=>({preset:we,sheet:null,text:""})),$e)}function Ht(s,e){let t=[],i=[];for(let a of e)a&&(a.sheet?s.adoptedStyleSheets.includes(a.sheet)||t.push(a.sheet):a.text&&i.push(a.text));t.length&&(s.adoptedStyleSheets=[...t,...s.adoptedStyleSheets]);for(let a of i.reverse()){let o=document.createElement("style");o.textContent=a,s.insertBefore(o,s.firstChild)}}function Mt(){return we}var Cs=/[A-Z]/g;function Lt(s){let e="shop-"+s.replace(Cs,i=>"-"+i.toLowerCase()),t=we.classes[s];return t?e+" "+t:e}var Se=m`
  .shop-label {
    display: block;
...
`;var Rs=It(),Ts=Se.styleSheet?{sheet:Se.styleSheet,text:""}:{sheet:null,text:Se.cssText},h=class extends L{static baseStyles=m`
    :host {
      display: block;
    }
    :host([hidden]) {
...
`;function Y({cls:s,id:e,name:t,autocomplete:i="current-password",required:a=!1,visible:o=!1,onToggle:c}){let g=o?r("password.hide"):r("password.show");return n`
  ...
  `}var Ge=class extends h{static properties={redirectUrl:{type:String,attribute:"redirect-url"},registerUrl:{type:String,attribute:"register-url"},heading:{type:String},_busy:{state:!0},_error:{state:!0},_passwortSichtbar:{state:!0}};static styles=[h.baseStyles,Z,m`
      .shop-message {
        margin-top: 1rem;
        max-width: var(--shop-form-width, 32rem);
      }
    ...
    `];constructor(){super(),this.redirectUrl="/",this.registerUrl="",this.heading="",this._busy=!1,this._error="",this._passwortSichtbar=!1}render(){return n`
      ...
      <form id="form" class=${this.cls("form")} part="form" @submit=${this.#e} novalidate>
        <div class="fields">
          ...
          <div class="field" part="field">
            ...
            ${Y({cls:this.cls("input"),id:"password",autocomplete:"current-password",required:!0,visible:this._passwortSichtbar,onToggle:()=>{this._passwortSichtbar=!this._passwortSichtbar}})}
          </div>
        </div>
    ...
    `}firstUpdated(){if(!this.hasAttribute("autofocus"))return;let e=this.$("email");e&&e.focus()}async#e(e){if(e.preventDefault(),this._busy)return;let t=this.$("email").value.trim(),i=this.$("password").value;if(!t||!i){this._error=r("login.missing");return}this._busy=!0,this._error="";try{await ke(t,i),x(P,{account:!0}),window.location.href=this.redirectUrl||"/"}catch(a){this._error=r(a.code),this._busy=!1,this.$("password").value="",this.$("password").focus()}}};customElements.define("shop-login",Ge);var zt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ft=s=>(...e)=>({_$litDirective$:s,values:e}),Ae=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:Ms}=Rt,Vt=s=>s;var Gt=()=>document.createComment(""),Q=(s,e,t)=>{let i=s._$AA.parentNode,a=e===void 0?s._$AB:e._$AA;if(t===void 0){let o=i.insertBefore(Gt(),a),c=i.insertBefore(Gt(),a);t=new Ms(o,c,s,s.options)}else{let o=t._$AB.nextSibling,c=t._$AM,g=c!==s;if(g){let d;t._$AQ?.(s),t._$AM=s,t._$AP!==void 0&&(d=s._$AU)!==c._$AU&&t._$AP(d)}if(o!==a||g){let d=t._$AA;for(;d!==o;){let y=Vt(d).nextSibling;Vt(i).insertBefore(d,a),d=y}}}return t},B=(s,e,t=s)=>(s._$AI(e,t),s),Ls={},jt=(s,e=Ls)=>s._$AH=e,Wt=s=>s._$AH,Pe=s=>{s._$AR(),s._$AA.remove()};var Kt=(s,e,t)=>{let i=new Map;for(let a=e;a<=t;a++)i.set(s[a],a);return i},k=Ft(class extends Ae{constructor(s){if(super(s),s.type!==zt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);let a=[],o=[],c=0;for(let g of s)a[c]=i?i(g,c):c,o[c]=t(g,c),c++;return{values:o,keys:a}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){let a=Wt(s),{values:o,keys:c}=this.dt(e,t,i);if(!Array.isArray(a))return this.ut=c,o;let g=this.ut??=[],d=[],y,$,p=0,_=a.length-1,b=0,w=o.length-1;for(;p<=_&&b<=w;)if(a[p]===null)p++;else if(a[_]===null)_--;else if(g[p]===c[b])d[b]=B(a[p],o[b]),p++,b++;else if(g[_]===c[w])d[w]=B(a[_],o[w]),_--,w--;else if(g[p]===c[w])d[w]=B(a[p],o[w]),Q(s,d[w+1],a[p]),p++,w--;else if(g[_]===c[b])d[b]=B(a[_],o[b]),Q(s,a[p],a[_]),_--,b++;else if(y===void 0&&(y=Kt(c,b,w),$=Kt(g,p,_)),y.has(g[p]))if(y.has(g[_])){let O=$.get(c[b]),Ue=O!==void 0?a[O]:null;if(Ue===null){let ht=Q(s,a[p]);B(ht,o[b]),d[b]=ht}else d[b]=B(Ue,o[b]),Q(s,a[p],Ue),a[O]=null;b++}else Pe(a[_]),_--;else Pe(a[p]),p++;for(;b<=w;){let O=Q(s,d[w+1]);B(O,o[b]),d[b++]=O}for(;p<=_;){let O=a[p++];O!==null&&Pe(O)}return this.ut=c,jt(s,d),H}});var Ds=/\S+@\S+\.\S+/,je=class extends h{static properties={mode:{type:String},redirectUrl:{type:String,attribute:"redirect-url"},loginUrl:{type:String,attribute:"login-url"},dataProtectionUrl:{type:String,attribute:"data-protection-url"},heading:{type:String},_salutations:{state:!0},_loading:{state:!0},_busy:{state:!0},_error:{state:!0},_accountExists:{state:!0},_business:{state:!0},_otherDelivery:{state:!0},_dataProtection:{state:!0},_sichtbar:{state:!0}};static styles=[h.baseStyles,Z,m`
      .block {
        margin-top: 2rem;
        padding-top: 1.5rem;
    ...
    `}validate(){this._error="",this._accountExists=!1;let e=[this.#s,this.#r];this._otherDelivery&&e.push(this.#t);for(let t of e)for(let i of t){if(!i.required||i.visible===!1)continue;let a=this.$(i.id);if(a&&!a.value.trim())return this._error=r("register.required")+i.label,a.focus(),!1}return this._dataProtection?this.$("email")?Ds.test(this.$("email").value.trim())?!this.isGuest&&this.$("password").value!==this.$("confirm-password").value?(this._error=r("register.passwordMismatch"),this.$("confirm-password").focus(),!1):!0:(this._error=r("register.emailInvalid"),this.$("email").focus(),!1):!1:(this._error=r("register.dataProtectionMissing"),!1)}values(){let e=i=>{let a=this.$(i);return a?a.value.trim():""},t={"account-type":this._business?"false":"true","company-name":this._business?e("company-name"):"",salutation:e("salutation"),name:e("name"),street:e("street"),city:e("city"),postcode:e("postcode"),country:e("country"),phone:e("phone"),email:e("email"),password:this.isGuest?"":this.$("password").value,"add-delivery-address":this._otherDelivery?"true":"false"};for(let i of this.#t)t[i.id]=this._otherDelivery?e(i.id):"";return t}async register(){return u("registerAccount",{...this.values(),guest:this.isGuest})}async#n(e){if(e.preventDefault(),this._busy||this.isGuest||!this.validate())return;this._busy=!0;let t=this.$("email").value.trim(),i=this.$("password").value;try{await this.register(),await ke(t,i),x(P,{account:!0}),window.location.href=this.redirectUrl||"/"}catch(a){this._busy=!1,a instanceof M&&a.code==="ACCOUNT_EXISTS"?(this._error=r("register.accountExistsHint"),this._accountExists=!0):this._error=r(a.code)}}};customElements.define("shop-register",je);var Zt={de:"de-DE",en:"en-GB"};function U(s){if(s==null||s==="")return 0;if(typeof s=="number")return Number.isFinite(s)?s:0;let e=String(s).trim(),t=e.includes(",")?e.replace(/\./g,"").replace(",","."):e,i=parseFloat(t);return Number.isFinite(i)?i:0}var We=null;function E(s){if(!We){let e=(document.documentElement.lang||"de").slice(0,2).toLowerCase();We=new Intl.NumberFormat(Zt[e]||Zt.de,{minimumFractionDigits:2,maximumFractionDigits:2})}return We.format(U(s))}function xe(s){let e=!!s.incShippingCosts;return{incShipping:e,shipping:e?U(s.shippingCosts):0,netto:U(e?s.nettoTotalSumIncShipping:s.nettoTotalSum),total:U(e?s.totalSumIncShipping:s.totalSum)}}function Bs(s){return{id:s.id,referencedId:s.referencedId,label:s.label,quantity:Number(s.quantity)||1,unitPrice:U(s.unitPrice),totalPrice:U(s.totalPrice),thumbnail:s.thumbnail||null,offered:s.offered!==!1}}function Yt(s){return{currency:s.currency||"",positions:(s.positions||[]).map(Bs),totals:xe(s)}}var Ke=class extends h{static properties={billingPage:{type:String,attribute:"billing-page"},canceledPage:{type:String,attribute:"canceled-page"},invoicingCanceled:{type:String,attribute:"invoicing-canceled"},mode:{type:String},checkoutUrl:{type:String,attribute:"checkout-url"},continueUrl:{type:String,attribute:"continue-url"},productUrl:{type:String,attribute:"product-url"},paypalImage:{type:String,attribute:"paypal-image"},heading:{type:String},_cart:{state:!0},_loading:{state:!0},_error:{state:!0},_message:{state:!0},_busy:{state:!0}};static styles=[h.baseStyles,m`
      .count {
        font-size: 1.25rem;
        margin: 0 0 1.5rem;
      }
    ...
    `}#p(e){let t=this._busy.has(e.id),i=this._cart.currency;return n`
      ...
      >
        ...
        <div>
          ...
          ${e.offered===!1?n`<div class="not-offered ${this.cls("alertError")}" role="status">${r("cart.notOffered")}</div>`:""}
    ...
    `}#f(){return`/shop-api/?${new URLSearchParams({action:"beginPayment",bill:this.billingPage,canceled:this.canceledPage})}`}};customElements.define("shop-cart",Ke);function Ce(){try{let s=localStorage.getItem("cookiesConsent");return s==="accepted"||s==="declined"}catch{return!1}}var Ee=new Map;function Jt(s){if(!Ee.has(s)){let e=u("gtmGetProductInfo",{product_id:s}).then(t=>t&&t.product?t.product:null).catch(()=>(Ee.delete(s),null));Ee.set(s,e)}return Ee.get(s)}function J(s){window.dataLayer=window.dataLayer||[],window.dataLayer.push(s)}function Xt(s,e){return{currency:s.currency||"EUR",value:s.price||0,items:[{item_name:s.name||"",item_id:s.id||"",price:s.price||0,item_category:s.category||"",quantity:e}]}}async function es(s){if(!Ce())return;let e=await Jt(s);e&&J({event:"view_item",ecommerce:Xt(e,1)})}async function ts(s,e){if(!Ce())return;let t=await Jt(s);t&&J({event:"add_to_cart",ecommerce:Xt(t,e||1)})}function ss(s){Ce()&&(!s||!s.positions.length||J({event:"begin_checkout",ecommerce:{currency:s.currency||"EUR",value:s.totals.total||0,items:s.positions.map(e=>({item_name:e.label||"",item_id:e.referencedId||"",price:e.totalPrice||0,quantity:e.quantity||1}))}}))}async function Qt(s){if(!globalThis.crypto||!globalThis.crypto.subtle)return null;try{let e=new TextEncoder().encode(String(s).trim().toLowerCase()),t=await globalThis.crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(i=>i.toString(16).padStart(2,"0")).join("")}catch{return null}}async function is(s){if(!Ce()||!s)return;if(s.email){let t=await Qt(s.email);t&&J({event:"emailAvailable",email:t})}if(s.phone){let t=await Qt(s.phone);t&&J({event:"phoneAvailable",phone:t})}let e;try{e=await u("gtmGetPurchasedProducts",{ar_link:s.ar_link})}catch{return}!e||!e.purchased||J({event:"purchase",ecommerce:{transaction_id:e.purchased.transaction_id||"",currency:e.purchased.currency||"EUR",value:e.purchased.value||0,shipping:e.purchased.shipping||0,items:(e.products||[]).map(t=>({item_name:t.name||"",item_id:t.id||"",price:t.price||0,item_category:t.category||"",quantity:t.quantity||1}))}})}var Ze=class extends h{static properties={product:{type:String},buttonText:{type:String,attribute:"button-text"},cartUrl:{type:String,attribute:"cart-url"},max:{type:Number},_quantity:{state:!0},_busy:{state:!0},_message:{state:!0},_error:{state:!0},_count:{state:!0}};static styles=[h.baseStyles,m`
      .quantity {
        display: flex;
        align-items: center;
        gap: 0.75rem;
    ...
    `}};customElements.define("shop-add-to-cart",Ze);function v(s){return s==null?"":String(s)}function ce(s){return{id:v(s.shipto_id),name:v(s.shiptoname),street:v(s.shiptostreet),zipcode:v(s.shiptozipcode),city:v(s.shiptocity),country:v(s.shiptocountry),email:v(s.shiptoemail),phone:v(s.shiptophone),used:s.used===!0||Number(s.used)>0}}function rs(s){return{id:v(s.shipto_default),name:v(s.shipto_name),street:v(s.shipto_street),zipcode:v(s.shipto_zipcode),city:v(s.shipto_city),country:v(s.shipto_country),email:v(s.shipto_email),phone:v(s.shipto_phone),used:!1}}function Re(s){return{street:v(s.street),zipcode:v(s.zipcode),city:v(s.city),country:v(s.country)}}function X(s,e){return s.name.localeCompare(e.name,void 0,{sensitivity:"base"})}function as(s){return s?Object.values(s).map(ce).sort(X):[]}function ns(){return{id:"",name:"",street:"",zipcode:"",city:"",country:"",email:"",phone:"",used:!1}}function Ye(s){return{name:s.name,street:s.street,city:s.city,zipcode:s.zipcode,country:s.country,email:s.email,phone:s.phone}}function os(s,e){return[v(s),v(e)].filter(Boolean).join(" ")}function C(s){return[[s.zipcode,s.city].filter(Boolean).join(" "),s.country].filter(Boolean).join(", ")}var Qe=class extends h{static properties={current:{type:String},overviewUrl:{type:String,attribute:"overview-url"},profileUrl:{type:String,attribute:"profile-url"},addressUrl:{type:String,attribute:"address-url"},orderUrl:{type:String,attribute:"order-url"},paymentUrl:{type:String,attribute:"payment-url"},showPayment:{type:Boolean,attribute:"show-payment"},_greeting:{state:!0}};static styles=[h.baseStyles,m`
      ul {
        list-style: none;
        margin: 0;
        padding: 0;
    ...
    `];#e=[];constructor(){super(),this.current="",this.overviewUrl="/pers\xF6nliche-daten/",this.profileUrl="/pers\xF6nliches-profil/",this.addressUrl="/adressen/",this.orderUrl="/bestellungen/",this.paymentUrl="/zahlungsarten/",this.showPayment=!1,this._greeting=""}connectedCallback(){super.connectedCallback(),this.#e.push(S(le,e=>{let t=e.detail||{};this._greeting=os(t.salutation,t.name)})),this.#e.push(S(P,e=>{e.detail&&e.detail.account===!1&&(this._greeting="")})),T().then(e=>{(!e||!e.account)&&(this._greeting="")}).catch(()=>{})}disconnectedCallback(){super.disconnectedCallback();for(let e of this.#e)e();this.#e=[]}#s(){let e=[{key:"overview",url:this.overviewUrl,label:r("account.nav.overview")},{key:"profile",url:this.profileUrl,label:r("account.nav.profile")},{key:"address",url:this.addressUrl,label:r("account.nav.address")},{key:"order",url:this.orderUrl,label:r("account.nav.order")}];return this.showPayment&&e.push({key:"payment",url:this.paymentUrl,label:r("account.nav.payment")}),e}render(){return n`
    ...
    `}};customElements.define("shop-account-nav",Qe);var A=class extends h{static properties={loginUrl:{type:String,attribute:"login-url"},heading:{type:String},_state:{state:!0},_error:{state:!0}};static accountStyles=m`
    .section {
      font-size: 1.15rem;
      font-weight: 600;
  ...
  `;#e=null;constructor(){super(),this.loginUrl="/login/",this.heading="",this._state="loading",this._error=""}connectedCallback(){super.connectedCallback(),this.#e=S(P,()=>{D().catch(()=>{}).then(()=>this.reload())}),this.reload()}disconnectedCallback(){super.disconnectedCallback(),this.#e&&this.#e(),this.#e=null}async load(){}renderAccount(){return l}async reload(){this._state="loading",this._error="";try{let e=await T();if(!e||!e.account){this._state="anonymous";return}await this.load(),this._state="ready"}catch(e){try{let t=await D();if(!t||!t.account){this._state="anonymous";return}}catch{}this._error=r(e&&e.code||"SHOP_API_ERROR"),this._state="error"}}announce(e,t){x(le,{salutation:e||"",name:t||""})}render(){return n`
    ...
    `}};var Je=class extends A{static properties={profileUrl:{type:String,attribute:"profile-url"},passwordUrl:{type:String,attribute:"password-url"},addressUrl:{type:String,attribute:"address-url"},deliveryUrl:{type:String,attribute:"delivery-url"},paymentUrl:{type:String,attribute:"payment-url"},_data:{state:!0}};static styles=[h.baseStyles,A.accountStyles,m`
      .cards {
    ...
    `}};customElements.define("shop-account-overview",Je);var Xe=class extends A{static properties={passwordHash:{type:String,attribute:"password-hash"},_profile:{state:!0},_salutations:{state:!0},_busy:{state:!0},_messages:{state:!0},_sichtbar:{state:!0}};static styles=[h.baseStyles,A.accountStyles,Z,m`
      form + .section {
        margin-top: 3rem;
      }
      .hint {
    ...
    `}#n(e,t,i){return n`
      <div class="field" part="field">
        ...
        ${Y({cls:this.cls("input"),id:e,autocomplete:i,required:!0,visible:!!this._sichtbar?.[e],onToggle:()=>{this._sichtbar={...this._sichtbar,[e]:!this._sichtbar?.[e]}}})}
      </div>
    ...
    `}};customElements.define("shop-account-profile",Xe);var et=class extends A{static properties={_methods:{state:!0},_selected:{state:!0},_busy:{state:!0},_message:{state:!0}};static styles=[h.baseStyles,A.accountStyles,m`
      fieldset {
        border: 0;
        margin: 0;
        padding: 0;
    ...
    `:n`<p class=${this.cls("muted")}>${r("payment.none")}</p>`}};customElements.define("shop-account-payment",et);var ls={de:"de-DE",en:"en-GB"},qs=/^(\d{4})-(\d{2})-(\d{2})$/;function tt(s){if(!s)return"";let e=String(s).trim(),t=qs.exec(e),i=t?new Date(Number(t[1]),Number(t[2])-1,Number(t[3])):new Date(e);if(Number.isNaN(i.getTime()))return e;let a=(document.documentElement.lang||"de").slice(0,2).toLowerCase();return i.toLocaleDateString(ls[a]||ls.de)}var st=class extends A{static properties={apiUrl:{type:String,attribute:"api-url"},productUrl:{type:String,attribute:"product-url"},thumbnailUrl:{type:String,attribute:"thumbnail-url"},_orders:{state:!0},_detail:{state:!0},_busy:{state:!0}};static styles=[h.baseStyles,A.accountStyles,m`
      .order {
        padding: 1.25rem;
        margin-bottom: 1rem;
        border: 1px solid var(--shop-border-color, #dee2e6);
    ...
    `}renderAccount(){return this._detail?this.#i():this.#a()}};customElements.define("shop-account-orders",st);var it=class extends A{static properties={_billing:{state:!0},_addresses:{state:!0},_defaultId:{state:!0},_form:{state:!0},_busy:{state:!0},_billingMessage:{state:!0},_formMessage:{state:!0},_listMessage:{state:!0}};static styles=[h.baseStyles,A.accountStyles,m`
      .default-card {
        max-width: 24rem;
      }
      .badge {
    ...
    `}renderAccount(){return this._billing?n`
      ...
      ${this._form?this.#c():n`<div class="actions" style="margin-top:0">
            <button
              ...
              part="add"
              ?disabled=${this._busy}
              @click=${()=>{this._form={mode:"new",address:ns()},this._formMessage=null}}
            >
              ${r("addresses.add")}
            </button>
          </div>`}
    ...
    `:l}};customElements.define("shop-account-addresses",it);function f(s){return s==null?"":String(s)}function cs(s){let e={registered:!!(s&&s.registered),salutations:s&&s.salutations||[],billing:null,defaultShipping:null,addresses:[]};return e.registered&&(e.billing={name:f(s.address&&s.address.name),street:f(s.address&&s.address.street),zipcode:f(s.address&&s.address.zipcode),city:f(s.address&&s.address.city),country:f(s.address&&s.address.country)},s.shipping&&s.shipping.name&&(e.defaultShipping={id:f(s.shipping.id),name:f(s.shipping.name),street:f(s.shipping.street),zipcode:f(s.shipping.zipcode),city:f(s.shipping.city),country:f(s.shipping.country),email:"",phone:"",used:!1}),e.addresses=(s.shipping_addresses||[]).map(ce).sort(X)),e}function rt(s){if(s.mode==="new"){let e=s.address||{};return{default:!1,id:null,name:f(e.name),street:f(e.street),city:f(e.city),zipcode:f(e.zipcode),country:f(e.country),email:f(e.email),phone:f(e.phone)}}return{default:!0,id:s.addressId?String(s.addressId):null}}function ds(s){let e={billing:{default:!1,salutation:f(s.salutation),account_type:f(s["account-type"]),name:f(s.name),street:f(s.street),city:f(s.city),zipcode:f(s.postcode),country:f(s.country),phone:f(s.phone),email:f(s.email)}};return s["add-delivery-address"]==="true"?e.shipping={default:!1,id:null,name:f(s["shipping-name"]),street:f(s["shipping-street"]),city:f(s["shipping-city"]),zipcode:f(s["shipping-postcode"]),country:f(s["shipping-country"]),email:f(s["shipping-email"]),phone:f(s["shipping-phone"])}:e.shipping={default:!0,id:null},e}function ee(){return{id:"",name:"",street:"",zipcode:"",city:"",country:"",email:"",phone:""}}function us(s){let e=new URLSearchParams(s||"").get("link");return e?e.trim():""}var at=class extends h{static properties={billingPage:{type:String,attribute:"billing-page"},canceledPage:{type:String,attribute:"canceled-page"},invoiceUrl:{type:String,attribute:"invoice-url"},loginUrl:{type:String,attribute:"login-url"},dataProtectionUrl:{type:String,attribute:"data-protection-url"},paypalImage:{type:String,attribute:"paypal-image"},heading:{type:String},_state:{state:!0},_error:{state:!0},_account:{state:!0},_mode:{state:!0},_selectedId:{state:!0},_form:{state:!0},_createAccount:{state:!0},_busy:{state:!0},_count:{state:!0},_accountExists:{state:!0}};static styles=[h.baseStyles,m`
      .layout {
        display: grid;
    ...
    `];#e=[];#s=!1;constructor(){super(),this.billingPage="",this.canceledPage="",this.invoiceUrl="/rechnung/",this.loginUrl="/login/",this.dataProtectionUrl="/datenschutz/",this.paypalImage="/images/paypal-de.png",this.heading="",this._state="loading",this._error="",this._account=null,this._mode="saved",this._selectedId="",this._form=ee(),this._createAccount=!1,this._busy=!1,this._accountExists=!1,this._count=null}connectedCallback(){super.connectedCallback(),this.#e.push(S(R,e=>this.#t(e.detail)),S(P,()=>this.#r())),this.#r()}disconnectedCallback(){super.disconnectedCallback();for(let e of this.#e)e();this.#e=[]}#t(e){!e||typeof e.count!="number"||(this._count=e.count,e.cart&&!this.#s&&(this.#s=!0,ss(e.cart)))}async#r(){this._state="loading",this._error="";try{let e=await u("billingAndShipping",{lang:document.documentElement.lang});this._account=cs(e),this._mode="saved",this._selectedId=this._account.defaultShipping?this._account.defaultShipping.id:"",this._form=ee(),this._state="ready"}catch(e){this._error=r(e.code||"SHOP_API_ERROR"),this._state="error"}}#a(){return this._mode==="new"?this._form:this._selectedId?this._account.addresses.find(e=>e.id===this._selectedId)||this._account.defaultShipping:null}#i(e){let t=this._account.addresses.find(i=>i.id===e);this._form=t?{...t}:ee()}#n(e,t){this._form={...this._form,[e]:t}}#l(){let e=this._form;return e.name.trim()?e.street.trim()?e.city.trim()?e.zipcode.trim()?e.country.trim()?"":r("register.country"):r("register.postcode"):r("register.city"):r("register.street"):r("register.name")}async#o(){if(this._busy||this._count===0)return;this._error="",this._accountExists=!1;let e=!this._account.registered,t=e?this.$("guest"):null,i;if(e){if(!t||!t.validate())return;i=ds(t.values())}else if(this._mode==="new"){let a=this.#l();if(a){this._error=r("register.required")+a;return}i=rt({mode:"new",address:this._form})}else i=rt({mode:"saved",addressId:this._selectedId});this._busy=!0;try{if(e){let o=await t.register();o&&o.shipto_id&&(i.shipping={default:!1,id:String(o.shipto_id)})}let a=await u("invoicing",{guest:e,adresses:i});window.location.href=this.#d(a)}catch(a){this._busy=!1,a.code==="ACCOUNT_EXISTS"?(this._accountExists=!0,this._error=r("register.accountExistsHint")):this._error=r(a.code||"SHOP_API_ERROR")}}#d(e){let t=new URLSearchParams({link:e&&e.ar_link||""});return(!e||e.email_status!=="success")&&t.set("mail","error"),`${this.invoiceUrl}?${t}#focus`}#u(){return`/shop-api/?${new URLSearchParams({action:"beginPayment",bill:this.billingPage,canceled:this.canceledPage})}`}render(){return this._state==="loading"?n`<p class=${this.cls("muted")} role="status">${r("checkout.loading")}</p>`:this._state==="error"?n`
    ...
    `}#p(){let e=this.#a(),t=this._account.defaultShipping?this._account.defaultShipping.id:"",i=this._account.addresses.filter(a=>a.id!==t);return n`
      ...
      <div class="actions">
        <button
          type="button"
          class=${this.cls("buttonSecondary")}
          @click=${()=>{this._form=ee(),this._mode="new"}}
        >
    ...
    `}#m(){return n`
      ...
      <div class="actions">
        <button
          type="button"
          class=${this.cls("buttonSecondary")}
          @click=${()=>{this._mode="saved",this._form=ee()}}
        >
          ${r("checkout.cancel")}
        </button>
      </div>
    ...
    `];constructor(){super(),this.apiUrl=Fe,this.ordersUrl="/bestellungen/",this.continueUrl="/",this.heading="",this._state="loading",this._error="",this._summary=null,this._mailFailed=!1}connectedCallback(){super.connectedCallback(),this.#e()}async#e(){let e=us(window.location.search);if(this._mailFailed=new URLSearchParams(window.location.search).get("mail")==="error",!e){this._state="missing";return}this._state="loading",this._error="";try{let t=await u("getInvoiceSummary",{ar_link:e});this._summary=t,this._state="ready",is(t)}catch(t){this._error=r(t.code||"SHOP_API_ERROR"),this._state="error"}}render(){if(this._state==="loading")return n`<p class=${this.cls("muted")} role="status">${r("invoice.loading")}</p>`;if(this._state==="missing")return n`
    ...
    `}};customElements.define("shop-invoice",nt);var ot=class extends h{static properties={loginUrl:{type:String,attribute:"login-url"},logoutUrl:{type:String,attribute:"logout-url"},registerUrl:{type:String,attribute:"register-url"},accountUrl:{type:String,attribute:"account-url"},cartUrl:{type:String,attribute:"cart-url"},loginLabel:{type:String,attribute:"login-label"},logoutLabel:{type:String,attribute:"logout-label"},registerLabel:{type:String,attribute:"register-label"},accountLabel:{type:String,attribute:"account-label"},cartLabel:{type:String,attribute:"cart-label"},_account:{state:!0},_count:{state:!0},_busy:{state:!0},_hint:{state:!0}};static styles=[h.baseStyles,m`
      ul {
        list-style: none;
        display: flex;
        flex-wrap: wrap;
    ...
    `}};customElements.define("shop-account-buttons",ot);function de(s){let e=String(s||"");if(!e)return"";try{let t=new URL(e,window.location.origin);return t.origin===window.location.origin?t.href:t.pathname+t.search+t.hash}catch{return e}}function Te(s){let e=new URLSearchParams(s||"").get("terms");return e?e.trim():""}var lt=class extends h{static properties={resultsUrl:{type:String,attribute:"results-url"},placeholder:{type:String},buttonLabel:{type:String,attribute:"button-label"},info:{type:String},minLength:{type:Number,attribute:"min-length"},autoFocus:{type:String,attribute:"auto-focus"},_items:{state:!0},_open:{state:!0},_active:{state:!0},_message:{state:!0}};static styles=[h.baseStyles,m`
      .info {
        display: block;
        margin-bottom: 0.5rem;
      }
    ...
    `}#t(e){let t=String(e.description||""),i=[e.partnumber,...e.breadcrumbs||[]].filter(Boolean).join(" | ");return n`
      <li>
        <a class="hit" part="hit" href=${de(e.hyperlink)}>
          <span>
    ...
    `}};customElements.define("shop-search-results",ct);var zs=/\S+@\S+\.\S+/,dt=class extends h{static properties={redirectUrl:{type:String,attribute:"redirect-url"},heading:{type:String},_salutations:{state:!0},_values:{state:!0},_state:{state:!0},_error:{state:!0},_busy:{state:!0}};static styles=[h.baseStyles,m`
      textarea {
        width: 100%;
        font: inherit;
      }
...
`}async#i(e){if(e.preventDefault(),this._busy)return;this._error="";let t=this.#r();if(t){this._error=r("contact.required")+t+r("contact.missing");return}if(!zs.test(this._values.email.trim())){this._error=r("contact.emailInvalid");let i=this.$("email");i&&i.focus();return}this._busy=!0;try{let i=await u("sendContactMail",{email:this._values.email.trim(),term:this.#a()});if(!(i&&(i.success===!0||i.success==="true"))){this._busy=!1,this._error=r("contact.sendFailed");return}window.location.href=this.redirectUrl}catch{this._busy=!1,this._error=r("contact.sendFailed")}}render(){return this._state==="loading"?n`<p class=${this.cls("muted")} role="status">${r("contact.loading")}</p>`:n`
    ...
    `}};customElements.define("shop-contact",dt);var ut=null;function hs(s){let e=document.getElementById("cart-count"),t=document.getElementById("cart-button"),i=document.getElementById("empty-cart-button");!e&&!t&&!i||(e&&(e.textContent=String(s)),t&&(t.style.display=s>0?"block":"none"),i&&(i.style.display=s>0?"none":"block"))}S(R,s=>{let e=s.detail&&s.detail.count;typeof e=="number"&&(ut=e,hs(e))});window.addEventListener("load",()=>{ut!==null&&setTimeout(()=>hs(ut),0)});S(P,()=>{D().catch(()=>{})});window.ShopUI=Object.freeze({version:"0.9.0",elements:["shop-login","shop-register","shop-cart","shop-add-to-cart","shop-account-nav","shop-account-overview","shop-account-profile","shop-account-payment","shop-account-orders","shop-account-addresses","shop-checkout","shop-invoice","shop-account-buttons","shop-search","shop-search-results","shop-contact"]});export{M as ApiError,le as SHOP_ACCOUNT_LOADED,P as SHOP_AUTH_CHANGED,R as SHOP_CART_CHANGED,Us as SHOP_ERROR,u as apiRequest,x as emit,T as getContext,S as on,D as refreshContext};
