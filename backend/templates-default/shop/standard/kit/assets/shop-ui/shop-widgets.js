...
`;var Rs=Mt(),Us=Se.styleSheet?{sheet:Se.styleSheet,text:""}:{sheet:null,text:Se.cssText},h=class extends L{static baseStyles=m`
    :host {
      display: block;
    }
    :host([hidden]) {
...
`;function Y({cls:s,id:e,name:t,autocomplete:i="current-password",required:a=!1,visible:o=!1,onToggle:c}){let g=o?r("password.hide"):r("password.show");return n`
  ...
  `}var Ge=class extends h{static properties={redirectUrl:{type:String,attribute:"redirect-url"},registerUrl:{type:String,attribute:"register-url"},heading:{type:String},_busy:{state:!0},_error:{state:!0},_passwortSichtbar:{state:!0}};static styles=[h.baseStyles,Z,m`
    ...
    `}firstUpdated(){if(!this.hasAttribute("autofocus"))return;let e=this.$("email");e&&e.focus()}async#e(e){if(e.preventDefault(),this._busy)return;let t=this.$("email").value.trim(),i=this.$("password").value;if(!t||!i){this._error=r("login.missing");return}this._busy=!0,this._error="";try{await ke(t,i),P(x,{account:!0}),window.location.href=this.redirectUrl||"/"}catch(a){this._error=r(a.code),this._busy=!1,this.$("password").value="",this.$("password").focus()}}};customElements.define("shop-login",Ge);var zt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ft=s=>(...e)=>({_$litDirective$:s,values:e}),Ae=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:Hs}=Rt,Vt=s=>s;var Gt=()=>document.createComment(""),Q=(s,e,t)=>{let i=s._$AA.parentNode,a=e===void 0?s._$AB:e._$AA;if(t===void 0){let o=i.insertBefore(Gt(),a),c=i.insertBefore(Gt(),a);t=new Hs(o,c,s,s.options)}else{let o=t._$AB.nextSibling,c=t._$AM,g=c!==s;if(g){let d;t._$AQ?.(s),t._$AM=s,t._$AP!==void 0&&(d=s._$AU)!==c._$AU&&t._$AP(d)}if(o!==a||g){let d=t._$AA;for(;d!==o;){let y=Vt(d).nextSibling;Vt(i).insertBefore(d,a),d=y}}}return t},B=(s,e,t=s)=>(s._$AI(e,t),s),Ls={},jt=(s,e=Ls)=>s._$AH=e,Wt=s=>s._$AH,xe=s=>{s._$AR(),s._$AA.remove()};var Kt=(s,e,t)=>{let i=new Map;for(let a=e;a<=t;a++)i.set(s[a],a);return i},k=Ft(class extends Ae{constructor(s){if(super(s),s.type!==zt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);let a=[],o=[],c=0;for(let g of s)a[c]=i?i(g,c):c,o[c]=t(g,c),c++;return{values:o,keys:a}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){let a=Wt(s),{values:o,keys:c}=this.dt(e,t,i);if(!Array.isArray(a))return this.ut=c,o;let g=this.ut??=[],d=[],y,$,p=0,_=a.length-1,b=0,w=o.length-1;for(;p<=_&&b<=w;)if(a[p]===null)p++;else if(a[_]===null)_--;else if(g[p]===c[b])d[b]=B(a[p],o[b]),p++,b++;else if(g[_]===c[w])d[w]=B(a[_],o[w]),_--,w--;else if(g[p]===c[w])d[w]=B(a[p],o[w]),Q(s,d[w+1],a[p]),p++,w--;else if(g[_]===c[b])d[b]=B(a[_],o[b]),Q(s,a[p],a[_]),_--,b++;else if(y===void 0&&(y=Kt(c,b,w),$=Kt(g,p,_)),y.has(g[p]))if(y.has(g[_])){let O=$.get(c[b]),Te=O!==void 0?a[O]:null;if(Te===null){let ht=Q(s,a[p]);B(ht,o[b]),d[b]=ht}else d[b]=B(Te,o[b]),Q(s,a[p],Te),a[O]=null;b++}else xe(a[_]),_--;else xe(a[p]),p++;for(;b<=w;){let O=Q(s,d[w+1]);B(O,o[b]),d[b++]=O}for(;p<=_;){let O=a[p++];O!==null&&xe(O)}return this.ut=c,jt(s,d),I}});var Ds=/\S+@\S+\.\S+/,je=class extends h{static properties={mode:{type:String},redirectUrl:{type:String,attribute:"redirect-url"},loginUrl:{type:String,attribute:"login-url"},dataProtectionUrl:{type:String,attribute:"data-protection-url"},heading:{type:String},_salutations:{state:!0},_loading:{state:!0},_busy:{state:!0},_error:{state:!0},_accountExists:{state:!0},_business:{state:!0},_otherDelivery:{state:!0},_dataProtection:{state:!0},_sichtbar:{state:!0}};static styles=[h.baseStyles,Z,m`
      .block {
        margin-top: 2rem;
        padding-top: 1.5rem;
  ...
  `;#e=null;constructor(){super(),this.loginUrl="/login/",this.heading="",this._state="loading",this._error=""}connectedCallback(){super.connectedCallback(),this.#e=S(x,()=>{D().catch(()=>{}).then(()=>this.reload())}),this.reload()}disconnectedCallback(){super.disconnectedCallback(),this.#e&&this.#e(),this.#e=null}async load(){}renderAccount(){return l}async reload(){this._state="loading",this._error="";try{let e=await U();if(!e||!e.account){this._state="anonymous";return}await this.load(),this._state="ready"}catch(e){try{let t=await D();if(!t||!t.account){this._state="anonymous";return}}catch{}this._error=r(e&&e.code||"SHOP_API_ERROR"),this._state="error"}}announce(e,t){P(le,{salutation:e||"",name:t||""})}render(){return n`
    ...
    `];#e=[];#s=null;constructor(){super(),this.loginUrl="/login/",this.logoutUrl="/logout/",this.registerUrl="/registrieren/",this.accountUrl="/pers\xF6nliche-daten/",this.cartUrl="/warenkorb/",this.loginLabel="",this.logoutLabel="",this.registerLabel="",this.accountLabel="",this.cartLabel="",this._account=!1,this._count=0,this._busy=!1,this._hint=!1}connectedCallback(){super.connectedCallback(),this.#e.push(S(x,e=>{let t=e.detail||{};typeof t.account=="boolean"?this._account=t.account:this.#t(D())}),S(R,e=>{let t=e.detail||{};typeof t.count=="number"&&(this._count=t.count)})),this.#t(U())}disconnectedCallback(){super.disconnectedCallback();for(let e of this.#e)e();this.#e=[],clearTimeout(this.#s)}async#t(e){try{let t=await e;if(!t)return;this._account=!!t.account,this._count=Number(t.cart_pos_count)||0}catch{}}async#r(){if(!this._busy){this._busy=!0;try{await Bt(),P(x,{account:!1}),window.location.href=this.logoutUrl}catch(e){this._busy=!1,this.#a(r(e.code||"SHOP_API_ERROR"))}}}#a(e){clearTimeout(this.#s),this._hint=e,this.#s=setTimeout(()=>{this._hint=!1},2500)}render(){return n`
      <ul part="buttons">
...
`}async#i(e){if(e.preventDefault(),this._busy)return;this._error="";let t=this.#r();if(t){this._error=r("contact.required")+t+r("contact.missing");return}if(!zs.test(this._values.email.trim())){this._error=r("contact.emailInvalid");let i=this.$("email");i&&i.focus();return}this._busy=!0;try{let i=await u("sendContactMail",{email:this._values.email.trim(),term:this.#a()});if(!(i&&(i.success===!0||i.success==="true"))){this._busy=!1,this._error=r("contact.sendFailed");return}window.location.href=this.redirectUrl}catch{this._busy=!1,this._error=r("contact.sendFailed")}}render(){return this._state==="loading"?n`<p class=${this.cls("muted")} role="status">${r("contact.loading")}</p>`:n`
    ...
    `}};customElements.define("shop-contact",dt);var ut=null;function hs(s){let e=document.getElementById("cart-count"),t=document.getElementById("cart-button"),i=document.getElementById("empty-cart-button");!e&&!t&&!i||(e&&(e.textContent=String(s)),t&&(t.style.display=s>0?"block":"none"),i&&(i.style.display=s>0?"none":"block"))}S(R,s=>{let e=s.detail&&s.detail.count;typeof e=="number"&&(ut=e,hs(e))});window.addEventListener("load",()=>{ut!==null&&setTimeout(()=>hs(ut),0)});S(x,()=>{D().catch(()=>{})});window.ShopUI=Object.freeze({version:"0.9.0",elements:["shop-login","shop-register","shop-cart","shop-add-to-cart","shop-account-nav","shop-account-overview","shop-account-profile","shop-account-payment","shop-account-orders","shop-account-addresses","shop-checkout","shop-invoice","shop-account-buttons","shop-search","shop-search-results","shop-contact"]});export{H as ApiError,le as SHOP_ACCOUNT_LOADED,x as SHOP_AUTH_CHANGED,R as SHOP_CART_CHANGED,Ts as SHOP_ERROR,u as apiRequest,P as emit,U as getContext,S as on,D as refreshContext};
