...
const crmDefaultsConfig = [
    ...
    { name: "accounting_ai_model", type: "select", items: [{ value: "claude-opus-4-8", title: "Claude Opus 4.8 (Genauer, Standard)" }, { value: "claude-sonnet-5", title: "Claude Sonnet 5 (Ausgewogen)" }, { value: "claude-haiku-4-5", title: "Claude Haiku 4.5 (Schneller)" }], fieldstyle: "max-width: 40ch", label: "crm_fields.accountingAiModel", tooltip: "crm_fields.accountingAiModel_help" },
