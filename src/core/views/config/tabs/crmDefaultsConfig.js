...
const crmDefaultsConfig = [
    ...
    // Das Modell der Belegerkennung steht zusammen mit denen der uebrigen
    // KI-Assistenten im Tab "KI und Gesundheit" (ai-health.tab.vue).
    ...
    // eBay ist ein Verkaufskanal der Shop-Erweiterung geworden
    // (dev/shop-verkaufskanaele.md, V15): alle Einstellungen stehen im Reiter
    // Shop. Hier nur der Hinweis dorthin — mit Warnung, wenn eBay noch
    // eingeschaltet ist, die Shop-Erweiterung aber nicht (V18).
    { name: "ebay", type: "headline", label: "crm_fields.ebayHeadline" },
    { name: "ebay_moved", type: "component", component: "ebay-moved" },
];
