...
const lxcarsDefaultsConfig = [
    ...
    { name: "localai", type: "headline", label: "crm_fields.localAi" },
    { name: "llm_url", type: "input", size: 60, fieldstyle: "max-width: 60ch", label: "crm_fields.llmUrl", tooltip: "crm_fields.llmUrl_help" },
    { name: "llm_model", type: "input", size: 30, fieldstyle: "max-width: 30ch", label: "crm_fields.llmModel", tooltip: "crm_fields.llmModel_help" },
